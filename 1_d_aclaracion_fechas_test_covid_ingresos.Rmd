...
- pobana_2, donde se han aplicado algunos criterio de exclusión (sociosanitarios, residentes y trabajadores en educación).

- test220613_cleaned, donde para cada persona está como máximo un test por día, con la fecha, el tipo de test y el resultado del mismo.
