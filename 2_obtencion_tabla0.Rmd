...
lista_criterios_exclusion <- lst(
  ...
  c7 = "Excluyendo: no finalizo vacunacion completa 90 dias antes..."
)

lista_variables_exclusion <- lst(
  v1 = "prfss",
  v2 = "educa",
  v3 = "resn",
  v4 = "depe",
...
pobana_0 %>% count(get(lista_variables_exclusion$v1))
pobana_0 %>% count(get(lista_variables_exclusion$v2))
pobana_0 %>% count(get(lista_variables_exclusion$v3))
pobana_0 %>% count(get(lista_variables_exclusion$v4))
pobana_0 %>% count(get(lista_variables_exclusion$v5))
...
f_flow <- function(fecha_0 = "2022-01-14", 
                   pob = pobana_0,
                   criterios_exclusion = lista_criterios_exclusion,
                   variables_exclusion = lista_variables_exclusion
                   ) {
  fecha0 <- ymd(fecha_0)
  print(paste("n de partida :", nrow(pob)))
  
  print(criterios_exclusion$c1) 
  pob %>% filter(is.na(get(lista_variables_exclusion$v1)) |
                     get(lista_variables_exclusion$v1) != TRUE) -> pob
    print(paste("n :", nrow(pob)))}

f_flow(fecha_0 = "2022-01-14")
