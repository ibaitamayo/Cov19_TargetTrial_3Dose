...
exclusion <- function(crit, 
                      var,
                      pob = pob)
{
  print(crit) 
  pob %>% filter(is.na(var) |
                     var != TRUE) -> pob
...
f_flow <- function(fecha_0 = "2022-01-14", 
                   pob = pobana_0,
                   crit_exclusion = lista_exclusion
                   ) 
  {
  
  fecha0 <- ymd(fecha_0)
  exclusion(crit = crit_exclusion$criterios$c1 ,
            var = crit_exclusion$variables$v1)
...
f_flow <- function(fecha_0 = "2022-01-14", 
  ...
  map_chr(criterios_exclusion, ~print(.x))}
