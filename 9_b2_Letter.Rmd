...
Summarising, i) in order to emulate the target trials it is interesting to have the exact home address of the participants to remove confounding, and ii) the booster has moderate effectiveness against infection, even in the mid-term time, and higher effectiveness against hospitalisations. 
