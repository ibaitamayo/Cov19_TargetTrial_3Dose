---
title: "MRNA Boosters Long-term effectiveness against COVID-19 infection and severe cases on Omicron-dominant period in Navarre"
...
We employed the target trial framework. In this approach, we emulate and describe a target random trial with the observational data. In particular, we perform three different target trials to answer each of the three research questions.

## Setting

***

The source population was the whole population of Navarre, a region of Spain of about 600 000 inhabitants. We selected people who have programmed the booster in the omicron-dominant period. Therefore, we selected individuals aged 40 years or older who had completed their primary vaccination at least 3 months before the start of follow-up, and had not tested positive for SARS-CoV-2 since the start of the pandemic. In addition, educational and health-care workers, and nursing home residents are also excluded since their vaccination calendar is different to the general population. We obtain all the information throughout the BARDENA databases [@Bardena2022].
...
First, we compare individuals with booster and no booster and we follow them until the infection is produced, death or the end of the follow-up. In case of the non-treated component of the pair receives the booster, both components are censored.
...
Finally, in the third trial, we compare individuals from 2022-01-04 to 2022-06-13 where the outcome of interest is the severe infection. Severe infection is defined as an hospital admission due to COVID-19.
