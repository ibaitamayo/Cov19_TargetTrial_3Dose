...
This work uses the target trial framework. In this approach, a target randomized trial is described and emulated with observational data. In particular, we performed four different target trials to answer each of the three research questions. (A) infection as outcome matching with typical confounding variables, (B) infection as outcome matching by home address, (C) COVID-19 related hospitalisation as outcome matching by age, sex and comorbidities, and (D) COVID-19 related deaths as outcome using the same matching as in (C).
...
All the work has been developed following carefully the WHO guidance and the STROBE statement. All the databases management and statistical analysis has been performed using R 4.2.
