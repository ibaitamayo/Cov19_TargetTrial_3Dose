...
pobana_2_2022_01_03 <- hacer_flujo_dep(poblacion = pobana_1_adaptada, 
...
```{r}
f_exposicion_seguimiento(data = pobana_2_2022_01_03,
                         tiempo_0 = "2022-01-03",
                         follow_up = 120
                           ) -> table_out_2022_01_03
...
fecha_inicio = ymd("2022-01-03")
fecha_fin = ymd("2022-02-06") 
...
lista[[1]] %>% count(exposicion)
lista[[2]] %>% count(exposicion)
lista[[3]] %>% count(exposicion)
lista[[1]] %>% count(exposicion)
