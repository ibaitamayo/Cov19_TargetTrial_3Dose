...
- Number of people at home (truncated at eight).
...
In addition, we use the home adress for doing the matching
...
When the matching is done by the home address, we are obtaining the next results:

<br>

```{r}
f_analisis2(lista = matching_fcv1_domi_2,
           tiempo_efecto = 7,
           lim_1 = 0.80,
           lim_zoom = 0.9)
