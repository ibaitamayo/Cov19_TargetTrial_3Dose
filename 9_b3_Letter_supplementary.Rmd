...
c) Target trial for ascertaining booster effectiveness against hospitalisations due to COVID-19 from 2022-01-04 to 2022-06-13. Matching each boostering day (from 2022-01-03 to 2022-06-12) by
...
table_1_m2 %>% 
  row_spec(c(29:36), bold = F, color = "black", background = "Chartreuse",
...
table_1_m4 %>% 
  row_spec(c(1:13, 37:44), bold = F, color = "black", background = "Chartreuse",
           extra_css = "vertical-align:middle")
