...
## funcionaba, pero no del todo, porque no acababa de registrar una lista de listas, con el resultado de cada combinacion de parametros.. entendia que el problema estaba en ese for y la lista receptaculo.. pero ahora ha dejado de funcionar, auqnue mal.. quizas tenga que entrar a esa parte del try(...
...
rm(data,pp,greedymatch,df,base_analisis)

# fecha de inicio y fin: secuencia de fechas
fecha_inicio=dmy("03/01/2022")
fecha_fin=dmy("06/01/2022") 
fechas <- seq.Date(from = fecha_inicio, to = fecha_fin, by = "days")
...
mod3=multparam(param)

str(out)
str(mod3)

# momenclatura fechas-match-out-fu
names(mod3)=c("e3f6_m9_ofcv_fu60","e3f6_m9_ofih_fu120","e3f6_m1_ofcv_fu120")



#function(fecha0, data, vector_match, out="fcv1",n=60 ) {
...
# 
# str(fechas)
# str(as.vector(pp$fechas[[1]]))
# 
# pp$fechas
# 
# ## pensemos en la estructua de ese data frame.. sobre el que se aplicará f_matching
