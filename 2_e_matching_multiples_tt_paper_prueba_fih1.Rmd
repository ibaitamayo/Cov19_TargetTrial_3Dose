...
```{r}
# se crean listas que dependen del proyecto------------------------------------
lista_exclusion_dep_sin_edad <- list(
  criterios = list(
  c1 = "Excluyendo: infección previa antes del tiempo_0...",
  # c2 = "Excluyendo: edad < 18 años en tiempo_0...", 
  c3 = "Excluyendo: pauta incompleta 90 días antes del tiempo_0...",
...
```{r}
# fih1
paper_fih1_sin_edad <- f_matching_tt_mult(
                data = pobana_2 %>% select(-fnac_18),
                f_ini = "2021-12-17",
                f_fin = "2022-06-12",
                crit_exc = lista_exclusion_dep_sin_edad,
                exposure = "fvc3",
                out = "fih1", 
...
```{r}
# fih1
paper_fih1_con_edad <- f_matching_tt_mult(
                data = pobana_2,
                f_ini = "2021-12-17",
                f_fin = "2022-06-12",
...
```{r}
f_analisis(paper_fih1_sin_edad, tiempo_efecto = 7, tipo = "event", lim_1 = 0.998)

```


```{r}
f_analisis(paper_fih1_con_edad, tiempo_efecto = 7, tipo = "event", lim_1 = 0.998)
