...
```{r}
load(file.path("Resultados", "out4.Rdata"))


f_analisis(out[["e3f6_m9_ofih_fu120"]]) %>% arrange(survtime) 
...
pp <- f_matching(fecha0 = "2021-12-23",
              data = lt,
              vector_match = c("gen", "gedad", "migran"))

###########
pp %>% janitor::tabyl(mexp, res)
