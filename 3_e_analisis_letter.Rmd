...
gg1 <- ggsurvplot(fit, data = base_analisis_m1,
           ...
           legend.title = " ",
           title = "A) Infections from 2022-01-04 to 2022-03-31. Matching each boostering day (from 2022-01-03 to 2022-03-30) for age, sex, previous negative test,
           primary vaccine type and date, health basic zone, migrant status, flu vaccinated in 2020 and in 2021, and the number of people at home",
           font.title = 16,
           conf.int = FALSE) 
...
gg2 <- ggsurvplot(fit, data = base_analisis_m2,
           ...
           legend.labs = c("No booster", "Booster"),
           legend.title = " ",
           title = "B) Infections from 2022-01-04 to 2022-03-31. Matching each boostering day (from 2022-01-03 to 2022-03-30) for home address",
           font.title = 16,
           conf.int = FALSE) 
...
gg3 <- ggsurvplot(fit, data = base_analisis_m3,
           ...
           legend.labs = c("No booster", "Booster"),
           legend.title = " ",
           title = "C) Hospitalisations from 2022-01-04 to 2022-06-13. Matching each boostering day (from 2022-01-03 to 2022-06-12) for age and sex",
           font.title = 16,
           conf.int = FALSE) 
...
ggsave("Fig1.svg", height = 13, width = 14, units = "in")
ggsave("Fig1.tiff", height = 13, width = 14, units = "in")
ggsave("Fig1.pdf", height = 13, width = 14, units = "in")
ggsave("Fig1.jpg", height = 13, width = 14, units = "in")
ggsave("Fig1.png", height = 13, width = 14, units = "in")
