...
gg1$plot <- gg1$plot + 
      ...
      geom_text(x = 21, y = 0.2, 
                label = glue("Short-term effectiveness: {rr_m1_st$rr_eff}"), 
                size = 4.5) +
      # mid term effectiveness
      geom_segment(y = 0.16, yend = 0.16,
                   x = 7, xend = 91, size = 1,
      arrow = arrow(length = unit(0.1, "inches"))) +
      geom_text(x = 70, y = 0.18, 
                label = glue("Mid-term effectiveness: {rr_m1$rr_eff}"), 
                size = 4.5) +
...
gg2$plot <- gg2$plot + 
      ...
      arrow = arrow(length = unit(0.1, "inches"))) +
      geom_text(x = 21, y = 0.2, 
                label = glue("Short-term effectiveness: {rr_m2$rr_eff}"), 
                size = 4.5) +
      # mid term effectiveness
      geom_segment(y = 0.16, yend = 0.16,
                   x = 7, xend = 91, size = 1,
      arrow = arrow(length = unit(0.1, "inches"))) +
      geom_text(x = 70, y = 0.18, 
                label = glue("Mid-term effectiveness: {rr_m2$rr_eff}"), 
                size = 4.5) +
      theme(axis.title.x = element_text(size = 14),
            plot.title = element_text(size = 14, face = "bold"))
...
gg3$plot <- gg3$plot + 
      ...
      geom_text(x = 21, y = 0.0018, 
                label = glue("Short-term effectiveness: {rr_m3$rr_eff}"), 
                size = 4.5) +
      # mid term effectiveness
      geom_segment(y = 0.0014, yend = 0.0014,
                   x = 7, xend = 91, size = 1,
      arrow = arrow(length = unit(0.1, "inches"))) +
      geom_text(x = 70, y = 0.0016, 
                label = glue("Mid-term effectiveness: {rr_m3$rr_eff}"), 
                size = 4.5) +
      theme(axis.title.x = element_text(size = 14),
            plot.title = element_text(size = 14, face = "bold"))
