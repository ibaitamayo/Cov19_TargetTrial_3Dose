...
matching_fcv1_longer <- f_matching_tt_mult(
                data = pobana_2,
                f_ini = "2022-01-03",
                f_fin = "2022-06-13",
                crit_exc = lista_exclusion_dep,
...
# guardar resultados-----------------------------------------------------------
saveRDS(matching_fcv1_longer, file.path("Resultados",
...
```{r}
# follow-up = 60, f_fin = 13-04-2022
matching_fih1_longer <- f_matching_tt_mult(
                data = pobana_2,
                f_ini = "2022-01-03",
                f_fin = "2022-06-13",
                crit_exc = lista_exclusion_dep,
...
# guardar resultados-----------------------------------------------------------
saveRDS(matching_fih1_longer, file.path("Resultados",
        "matching_fih1_longer.RDS"))

```

# fih1 más tiempo. age 1 year.

```{r}
# follow-up = 60, f_fin = 13-04-2022
matching_fih1_longer_2 <- f_matching_tt_mult(
                data = pobana_2,
                f_ini = "2022-01-03",
                f_fin = "2022-06-13",
                crit_exc = lista_exclusion_dep,
...
# guardar resultados-----------------------------------------------------------
saveRDS(matching_fih1_longer_2, file.path("Resultados",
